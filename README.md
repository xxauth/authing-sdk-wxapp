...
> 你可以使用 `authing-sdk-js` [AuthenticationClient](https://docs.authing.co/sdk/sdk-for-node/authentication/AuthenticationClient.html) 中的所有方法，调用方法和 `authing-sdk-js` 完全一致。
